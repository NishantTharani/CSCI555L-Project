...
for i in range(nodeCount):
    ...
    node.addService(rspec.Execute(shell="sh", command="echo " + str(worker_count) + " > /tmp/worker_count.txt"))
    node.addService(rspec.Execute(shell="sh", command="echo " + str(client_count) + " > /tmp/client_count.txt"))
