...
for i in range(nodeCount):
    ...
    node.addService(rspec.Execute(shell="sh", command="echo " + str(worker_count) + " > /tmp/node_counts.txt"))
    node.addService(rspec.Execute(shell="sh", command="echo " + str(client_count) + " >> /tmp/node_counts.txt"))
